...
const SubscribePage = () =>
  ...
  <p>  To contact us, please email us at <a href= "pennchristianjournal@gmail.com"> </a>
    If you would like to contribute to the journal, please see the instructions for submissions.
</p>
  ...
  <div id="mc_embed_signup">
    <form action="//pennchristianjournal.us13.list-manage.com/subscribe/post?u=0c6ca517c3cf489926ee85a20&amp;id=ce14e6980f" className="validate" id="mc-embedded-subscribe-form" method="post" name="mc-embedded-subscribe-form" noValidate="" target="_blank">
          ...
          <input className="required email" id="mce-EMAIL" name="EMAIL" type="email" value="" />
  			...
  			<div className="mc-field-group">
  				<label htmlFor="mce-FNAME">First Name</label> <input id="mce-FNAME" name="FNAME" type="text" value="" />
  			</div>
  			<div className="mc-field-group">
  				<label htmlFor="mce-LNAME">Last Name</label> <input id="mce-LNAME" name="LNAME" type="text" value="" />
  			</div>
...
if (typeof document !== 'undefined') {
    ...
    render(
        <Provider store={store}><SubscribePage /></Provider>,
