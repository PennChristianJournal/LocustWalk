...
const SubscribePage = () =>
    <PanelPage id="submission-page"
        ...
        main={[
          <Helmet>
            <title>Subscribe - Locust Walk</title>
            <meta name="description" content={'Subscribe to our mailing list to receive our weekly newsletter and get notified of new articles!'.substring(0, 160)} />
          </Helmet>,
