...
const WritersGuideResponsePage = () => (
    <PanelPage
        main={[
          <Helmet>
            <title>Response Writers Guide - Locust Walk</title>
            <meta name="description" content={'Thank you for your interest in writing for Locust Walk! As a magazine, we are flexible in the topics and writing styles of submissions, however, there are standards that we uphold. Please use the following guidelines to direct your writing. We look forward to hearing from you!'.substring(0, 160)} />
          </Helmet>,
